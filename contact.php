...
?>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="contact.php">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="info-box card" style="text-align:center;">
                ...
                <p>Jl. Proklamasi No.2, Plaosan, Purworejo, Kecamatan Purworejo, Kabupaten Purworejo, Provinsi Jawa
                  Tengah 54111</p>
              </div>
            </div>
            <div class="col-lg-4">
