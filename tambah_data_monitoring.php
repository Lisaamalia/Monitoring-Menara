...
?>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6><?php echo $_SESSION['nama_users']; ?></h6>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="tambah_data_monitoring.php">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="post" action="proses_tambahdata.php">
                <input type="hidden" class="control" name="id_menara" size="50" maxlength="255">
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label">Kecamatan</label>
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" name="kec" id="kec">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" name="deskel" id="deskel">
                      ...
                      <option value="Banyuasin Separe">BANYUASIN SPARE</option>
                      <option value="Banyuurip">BANYUURIP</option>
                      ...
                      <option value="Jatingaran">JATINGARANG</option>
                      ...
                      <option value="Kemrnanggen">KEMRANGGEN</option>
                      ...
                      <option value="Pangenjurutengan">PANGENJURUTENGAH</option>
                      ...
                      <option value="Tlepok">TLEPOK</option>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nama_dukuh">
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" name="nama_perusahaan_menara"
                      ...
                      <option value="cmi">CMI (PT. Centratama Menara Indonesia)</option>
                      <option value="ems">EMS (PT. Era Mandiri Sejahtera)</option>
                      <option value="ibs">IBS (PT. Inti Bangun Sejahtera)</option>
                      <option value="indosat">INDOSAT (PT. Indosat Ooredpp Hutchinson)</option>
                      <option value="kin">KIN (PT. Komet Infra Nusantara)</option>
                      <option value="lainnya">Lainnya</option>
                      <option value="mitrateldmt">MITRATEL (PT. Daya Mitra Telekomunikasi)</option>
                      <option value="mitratelex">MITRATEL (PT. Ex. Telkomsel)</option>
                      <option value="protelindo">PROTELINDO (PT. Protelindo)</option>
                      <option value="stp">STP (PT. Solusi Tunas Pratama)</option>
                      <option value="tbg">TBG (PT. Tower Bersama Group)</option>
                      <option value="telkomsel">TELKOMSEL (PT. Telkomsel)</option>
                      <option value="triview">TRIVIEW (PT. Triview Geospatial Mandiri)</option>
                      <option value="xl">XL (PT. XL Axiata Tbk)</option>
                    </select>
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="titik_koordinat_longitude">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Titik Koordinat Latitude</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="titik_koordinat_latitude">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Radius Rebahan Menara</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="radius_rebahan_menara">
                  </div>
                </div>
