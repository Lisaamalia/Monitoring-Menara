...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="profile_pengguna.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="contact_pengguna.php">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $_SESSION['nama_users']; ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Jabatan</div>
                    <div class="col-lg-9 col-md-8"><?php echo $_SESSION['jabatan']; ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Jenis Kelamin</div>
                    <div class="col-lg-9 col-md-8"><?php echo $_SESSION['jk']; ?></div>
                  </div>
                  ...
                  <div>
                    <?php
                        echo "<div class='d-flex' ><button type='button' class='btn btn-primary'>";
                        echo "<a href='editprofil_pengguna.php?id_users=" . $_SESSION['id_users'] . "' style='color: white'>Edit Profile</a></button> </div> ";
                      ?>
                  </div>
